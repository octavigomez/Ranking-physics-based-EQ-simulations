...
fig25, axes =plt.subplots(8,1, dpi = 600, gridspec_kw=gridspec)
...
axs0.text(2, -0.006, "r=" + str(r_squared_final), fontsize = 6.5, horizontalalignment = "left", verticalalignment="bottom")
...
axs1.text(2, -0.015, "r=" + str(r_squared_AM), fontsize = 6.5, horizontalalignment = "left", verticalalignment = "top")
...
axs2.text(2, -0.006, "r=" + str(r_squared_AD), fontsize = 6.5, horizontalalignment = "left", verticalalignment="bottom")
...
axs4.text(2, -0.006, "r=" + str(r_squared_MFD), fontsize = 6.5, horizontalalignment = "left", verticalalignment="bottom")
